...
func TestCreateTenant_SlugTaken(t *testing.T) {
	...
	_, err := svc.CreateTenant(context.Background(), &tenant.CreateTenantRequest{Name: "x", Slug: "s", Domain: "d", Plan: tenant.PlanFree, Settings: tenant.TenantSettings{}, AdminUser: tenant.CreateTenantAdminRequest{Email: "a@b.com", Password: "TestPass123!", FirstName: "A", LastName: "B"}})
	if err == nil {
...
func TestCreateTenant_Success(t *testing.T) {
	...
	req := &tenant.CreateTenantRequest{Name: "n", Slug: "unique", Domain: "d", Plan: tenant.PlanFree, Settings: tenant.TenantSettings{}, AdminUser: tenant.CreateTenantAdminRequest{Email: "a@b.com", Password: "TestPass123!", FirstName: "A", LastName: "B"}}
